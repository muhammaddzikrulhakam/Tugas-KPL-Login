    ...
    <div class="col-md-4 col-md-offset-4">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title" align="center">Registrasi Akun</h3>
        </div>
          <div class="panel-body">
            <form accept-charset="UTF-8" role="form" method="post" action="prosesdaftar.php">
            <div class="form-group">
                  <label for="">Nama</label>
                  <input class="form-control" placeholder="username" name="nama" type="text" required="">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
               ...
               <button type="submit" class="btn btn-success btn-block btn-flat" name="daftar"> <i class="fa fa-sign-in"></i> Daftar Sekarang</button>
